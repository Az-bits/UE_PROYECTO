<%
    ...
    if (nuevaVista == "Dashboard") {
        nuevaVista = nuevaVista + ".jsp";
    } else {
        if (nuevaVista.substring(0, 3).equals("frm")) {
            
            String carpeta = nuevaVista.substring(3).toLowerCase();
            vista = carpeta;
            nuevaVista = carpeta + "/" + nuevaVista + ".jsp";
        } else {
            nuevaVista = nuevaVista + "/" + nuevaVista + ".jsp";
        }
    }
%>
...
<html lang="en">
    <head>
        ...
        <link
            ...
            sizes="76x76"
            href="./plantilla/assets/img/apple-icon.png"
            />
        ...
        <link
            id="pagestyle"
            href="./plantilla/assets/css/soft-ui-dashboard.min.css?v=1.0.7"
            rel="stylesheet"
            />
    ...
    <body class="g-sidenav-show bg-gray-100">
        <jsp:include page="Menu.jsp">
            <jsp:param name="opcion" value="<%= vista %>"/>
        </jsp:include> 
        <main
            class="main-content position-relative max-height-vh-100 h-100 border-radius-lg"
            >
            <jsp:include page="templater/header.jsp">
                <jsp:param name="pagina" value="<%= vista %>"/>
            </jsp:include>
            <div class="container-fluid py-4">
                <jsp:include page="<%= nuevaVista %>" > 
                        ...
                        <div class="row align-items-center justify-content-lg-between">
                            <div class="col-lg-6 mb-lg-0 mb-4">
                                <div
                                    ...
                                    , realizado con <i class="fa fa-heart"></i> por
                                    <a
                                        href="#"
        ...
        <script src="./plantilla/assets/js/soft-ui-dashboard.min.js?v=1.0.7"></script>
        <script src="./plantilla/assets/js/plugins/sweetalert.min.js"></script>
    </body>
</html>
