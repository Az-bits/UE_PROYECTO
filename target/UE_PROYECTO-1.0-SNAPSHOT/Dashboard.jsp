        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
            <div class="card z-index-2">
                <div class="card-body p-3">
                    ...
                    <h6 class="ms-2 mt-4 mb-0">Promedio general notas de los estudiantes</h6>
                        ...
                        <div class="row">
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Aprovados</p>
                                </div>
                                <h4 class="font-weight-bolder">86%</h4>
                                <div class="progress w-75">
                                    <div
                                        class="progress-bar bg-dark w-80"
                                        role="progressbar"
                                        aria-valuenow="86"
                                        aria-valuemin="0"
                                        aria-valuemax="100"
                            ...
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Reprovados</p>
                                </div>
                                <h4 class="font-weight-bolder">14%</h4>
                                <div class="progress w-75">
                                    <div
                                        class="progress-bar bg-dark w-20"
                                        role="progressbar"
                                        aria-valuenow="14"
                                        aria-valuemin="0"
                                        aria-valuemax="100"
        ...
        <div class="col-lg-7">
            <div class="card z-index-2">
                <div class="card-header pb-0">
                    <h6>Plan academico</h6>
                    <p class="text-sm">
                        <i class="fa fa-arrow-up text-success"></i>
                        <span class="font-weight-bold">60% </span> 2023 
                    </p>
                </div>
                <div class="card-body p-3">
                    <div class="chart">
